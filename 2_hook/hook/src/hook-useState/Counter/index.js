        ...
        <>
            ...
            <ul>
                {products.map(product => (
                    <li key={product.id}>Id :{product.id} - Name : {product.name} - Price : {product.price}</li>
                ))}
            </ul>

            <input placeholder='Enter id' value={idProduct} onChange={e => setIdProduct(e.target.value)} />

            <br />

            <input placeholder='Enter name' value={nameProduct} onChange={e => setNameProduct(e.target.value)} />
            <button onClick={changeNameProduct}>Change name</button>

            <br />

            <input placeholder='Enter price' value={priceProduct} onChange={e => setPriceProduct(e.target.value)} />
