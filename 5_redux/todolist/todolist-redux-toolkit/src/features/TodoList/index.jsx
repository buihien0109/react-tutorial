...
import { v4 } from "uuid";
import { addTodo, addTodoOther, deleteTodo, updateTodo } from "../../redux/slices/todosSlice";
import "./TodoList.css";
...
function TodoList() {
    ...
    const handleAddTodoOther = () => {
        const newTodo = {
            title: title,
        };
        dispatch(addTodoOther(newTodo));
    ...
    return (
        <div>
            ...
            <button onClick={handleAddTodoOther}>Add Other</button>
